...
public class Map
{
    ...
    public Vector3 AdjustZ(Vector3 size, bool floating, ref Vector3 pos)
    {
        ...
        {
            pos.x = m_StartPos.x + size.x * MapUtil.m_MapGridUnityLen / 2.0f;
            if (floating)
            {
                pos.x += 0.3f;
            }
    ...
    public void GetMinMaxPos(Vector3 size, bool onFloor, ref DragInitData data)
    {
        ...
        {
            data.m_MinPos = m_StartPos
                + new Vector3(0, size.y * MapUtil.m_MapGridUnityLen / 2, size.z * MapUtil.m_MapGridUnityLen / 2);
    ...
    public Vector3 Grid2Pos(Vector3 grid)
    {
        ...
        {
            ret.z = m_StartPos.z + MapUtil.m_MapGridUnityLen / 2 + grid.z * MapUtil.m_MapGridUnityLen;
        }
    ...
    public Vector3 Pos2Grid(Vector3 pos)
    {
        ...
        {
            ret.z = (int)((pos.z - (m_StartPos.z + MapUtil.m_MapGridUnityLen / 2)) / MapUtil.m_MapGridUnityLen);
        }
    ...
    /// <returns></returns>
    public Vector3 GetCorner(Vector3 pos, Vector3 size, bool min)
    {
        Vector3 ret = Vector3.zero;
        if (min)
        {
